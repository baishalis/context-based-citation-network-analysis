...
public class MetricsCutRatioIndirect {
	...
	public static class PaperEntryReducer extends TableReducer<Text, Text, ImmutableBytesWritable> {
		...
		protected void reduce(Text forClass, Iterable<Text> counts, Context context)
			...
			put.add(Bytes.toBytes("metricsIndirect"), Bytes.toBytes("cutRatio"), Bytes.toBytes(Double.toString(cut)));
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(MetricsCutRatioIndirect.class);
