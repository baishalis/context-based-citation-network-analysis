...
public class MetricsExpansionIndirect {
	...
	public static class PaperEntryReducer extends TableReducer<Text, Text, ImmutableBytesWritable> {
		...
		//	System.out.println(forClass + "\t" + expansion);
			...
			put.add(Bytes.toBytes("metricsIndirect"), Bytes.toBytes("expansion"), Bytes.toBytes(Double.toString(expansion)));
	...
	public static void main(String[] args) throws Exception {
		...
		Job job = new Job(conf, "MetricsExpansionIndirect");

		job.setJarByClass(MetricsExpansionIndirect.class);
