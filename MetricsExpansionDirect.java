...
public class MetricsExpansionDirect {
	...
	public static class PaperEntryReducer extends TableReducer<Text, Text, ImmutableBytesWritable> {
		...
		//	System.out.println(forClass + "\t" + expansion);
			...
			put.add(Bytes.toBytes("metricsDirect"), Bytes.toBytes("expansion"), Bytes.toBytes(Double.toString(expansion)));
	...
	public static void main(String[] args) throws Exception {
		...
		Job job = new Job(conf, "Expansion");

		job.setJarByClass(MetricsExpansionDirect.class);
