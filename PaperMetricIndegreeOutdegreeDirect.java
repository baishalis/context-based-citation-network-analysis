...
public class PaperMetricIndegreeOutdegreeDirect {
	...
	public static class PaperEntryReducer extends TableReducer<Text, Text, ImmutableBytesWritable> {
		...
		protected void reduce(Text paper, Iterable<Text> type, Context context)
			...
			put.add(Bytes.toBytes("metricsDirect"), Bytes.toBytes("indegree"), Bytes.toBytes(countin + ""));
			put.add(Bytes.toBytes("metricsDirect"), Bytes.toBytes("outdegree"), Bytes.toBytes(countout + ""));
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(PaperMetricIndegreeOutdegreeDirect.class);
